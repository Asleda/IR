...
def main():
  ...
  while  True:
    try:
      auth = tweepy.OAuthHandler('XeoDBO6ajyIUTnjcap0rHjiFZ',  'y4b0huVYovDv3vPZ5q45gohbjENf5940KCZSidzPGyNM8kgQav')
      auth.set_access_token('866636850680614912-YqWK47kvmXSQhtCE5FHT9rq26tEEf1z', 'Ps42JHedIpCbFzTE99I5a1XncrxetlwjFfDcwDtquA4DW')
